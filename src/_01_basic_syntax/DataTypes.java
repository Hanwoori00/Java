...
public class DataTypes {
    public static void main(String[] args) {
        ...
        //정수형 변수 선언
        int x = 10;
        long y = 10000000L; // long 타입은 뒤에 대문자나 소문자 L을 붙여야.
        short z = 3445;
        byte b = 123;

        //실수형 변수 선언
        float a = 3.14f; // float 도 뒤에 'f'나 'F' 붙여야.
        double c = 2.456;
        ...
        // - 기본 자료형은  "==" 비교하지만, String 같은 객체간 비교는 .equals() 메소드 사용
        ...
        for (int i = 0; i < nums.length; i++) {
            System.out.print(nums[i] + " "); // System.out.print 여기서 ln 없으면 개행 없이 연결해서 print 해줌
        }
        //ver. for-each문
        for (int num : nums) {
        ...
        Person person = new Person("Joseph", 30);
